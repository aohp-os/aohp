...
<p align="center">
  <img src="../pic/cartoon_comic.png" alt="AOHP 漫画概览：从人类操作的 Android 到智能体原生操作系统" width="95%"/>
</p>
...
<p align="center">
  <img src="../pic/demo.png" alt="原生 Android 与 AOHP 购物任务对比" width="95%"/>
</p>

> [!IMPORTANT]
> **研究预览。** AOHP 是一个早期阶段的研究原型。我们的技术报告阐述了项目背后的系统洞察和长期愿景：构建一个面向智能体的 Android 操作系统级 harness，用于支持个性化服务组合、高效的智能体交互接口，以及更安全的信息流管理。
>
> 当前仓库是这一愿景的初步开源实现，主要面向研究实验、技术探索和社区反馈，而非生产环境或安全关键场景。当前代码尚未经过大规模兼容性测试、生产级加固、独立安全审计或同行评审。我们不建议在当前版本中处理真实敏感信息、生产任务或安全关键工作负载。
>
> 我们将持续推进 AOHP 的开发，逐步实现技术报告中描述的完整机制，提升系统稳定性、兼容性和安全覆盖范围，并随着项目演进引入新的功能。欢迎研究者、开发者和开源社区提出反馈、问题和贡献。
...
<tr>
<td align="center"><a href="../demos/uda/health_hub_demo.mp4"><img src="../demos/uda/health_hub_demo.gif" alt="Health Hub 演示" width="220"/></a></td>
<td align="center"><a href="../demos/uda/gift_picker_demo.mp4"><img src="../demos/uda/gift_picker_demo.gif" alt="Gift Picker 演示" width="220"/></a></td>
<td align="center"><a href="../demos/uda/python_learning_assistant_demo.mp4"><img src="../demos/uda/python_learning_assistant_demo.gif" alt="Python Learning Assistant 演示" width="220"/></a></td>
</tr>
<tr>
...
<tr>
<td align="center"><a href="../demos/agent/gallery_brightness.mp4"><img src="../demos/agent/gallery_brightness.gif" alt="UI 微操作演示" width="220"/></a></td>
<td align="center"><a href="../demos/agent/cloud_file_markor.mp4"><img src="../demos/agent/cloud_file_markor.gif" alt="文件处理演示" width="220"/></a></td>
<td align="center"><a href="../demos/agent/taskdriver_calendar.mp4"><img src="../demos/agent/taskdriver_calendar.gif" alt="事件捕获演示" width="220"/></a></td>
</tr>
</table>
